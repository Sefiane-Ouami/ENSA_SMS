 ...
 * @author hp
 */
public class PagePhaseAppelOffre extends javax.swing.JFrame {
    public static int a = 0;
    public static int b = 0;
    /**
     * Creates new form PagePhaseAppelOffre
     */
    public PagePhaseAppelOffre() {
        initComponents();
        logouticon();
        jLabel5.setText("30 : 00 : 00 : 00");
        }
    ...
    private void initComponents() {
        ...
        setTitle("Page pour le lancement d'appel d'offre");
        ...
        jLabel3.setText("Lancement d'appel d'offre pour les enseignants-chercheurs :");
        ...
        jLabel4.setText("Cette phase sera désactivé dans  : ");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 160, 420, 30));

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, 420, 70));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                 b = 10;
                seconds --;
                jLabel5.setText(days+" : "+hours+" : "+minutes+ " : "+seconds);
                if(seconds == -1){
                    seconds = 59;
                    minutes--;
                jLabel5.setText(days+" : "+hours+" : "+minutes+ " : "+seconds);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagePhaseAppelOffre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
