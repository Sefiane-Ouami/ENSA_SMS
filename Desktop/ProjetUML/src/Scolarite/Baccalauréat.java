 ...
 * @author hp
 */
public class Baccalauréat extends javax.swing.JFrame {
    Connection conn = null;
    Statement stmt = null;
    ResultSet rs = null;
    /**
     * Creates new form Baccalauréat
     */
    public Baccalauréat() {
        initComponents();
        try {
			byte[] imageByte;
	    	   ...
	    	   Class.forName("com.mysql.cj.jdbc.Driver");
	    	    ...
	    	    rs = stmt.executeQuery("SELECT bac FROM inscriptions where etudiant_id = "+PageDemandeInscriptionScolarite.id);
	            if(rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Baccalauréat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
