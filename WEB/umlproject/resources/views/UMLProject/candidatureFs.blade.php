    ...
    <div class="container-fluid Bac">
        <div class="row">
            ...
            <div class="col-lg-8 content">
                    ...
                    <div class="infos">
                        <legend class="title1" style="color: #13448C;">------------------------------------
                            Les informations d'étudiant
                            -----------------------------------</legend>
                        <form class="row g-3" method="post" action="{{route('ajoutercandidature',$id)}}">
                        @csrf
                            <div class="col-md-6">
                              <input type="text" class="form-control" id="inputnom" value="{{$nom}}" placeholder="Nom" name="nom" >
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="inputprenom" value="{{$prenom}}" placeholder="Prenom" name="prenom" >
                            </div>
                            <div class="col-md-6">
                                <input type="date" class="form-control" id="inputdate" value="{{$date_naissance}}" placeholder="Date de naissance"  name="date_naissance">
                            </div>
                            <div class="col-md-6">
                            ...
                            <legend class="title2" style="color: #13448C;">------------------------------------
                                Les documents d'étudiant
                                ------------------------------------</legend>
                            <div class="col-md-6">
                                <div class="file">
                                    <label for="file2">Votre Deug / licence :</label>
                                    <input type="file" id="file2" name="diplome" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="file">
                                    <label for="file3">Votre Relevé des notes :</label>
                                    <input type="file" id="file3" name="releve_notes" >
                                </div>
                            </div>
                            <div class="col-10">
